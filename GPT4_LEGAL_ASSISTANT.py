...
def save_to_markdown(step_name, content, chain_name, user_query):
    ...
    filename = f"GPT4_markdown_outputs/{timestamp}_{session_id}_{chain_name}_{step_name}.md"
...
def run_application(user_query):
    ...
    OPENAI_JUDGE = ChatPromptTemplate.from_template(
f"""
...
""")
    ...
    final_balancer_chain = OPENAI_JUDGE | llm3 | StrOutputParser()
...
"""
    ...
    final_filename = f"GPT4_markdown_outputs/{timestamp}_{session_id}_FINAL_LEGAL_ANALYSIS.md"
